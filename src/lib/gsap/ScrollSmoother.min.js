      ...
      ((ScrollSmoother.register = function register(e) {
        return (
          D ||
            ...
            s() &&
              window.document &&
              ((U = window), (j = document), (G = j.documentElement), (K = j.body)),
            I &&
              ((q = I.utils.toArray),
              (V = I.utils.clamp),
              (W = I.parseEase('expo')),
  ...
  function ScrollSmoother(t) {
    ...
    function Ka(e) {
      ((S.scrollTop = 0),
        (e.target.contains && e.target.contains(S)) ||
          (C && !1 === C(o, e)) ||
          (Y.isInViewport(e.target) || e.target === p || o.scrollTo(e.target, !1, 'center center'),
          (p = e.target)));
    }
    function La(t, e) {
        ...
        return (function adjustEffectRelatedTriggers(e, t, r) {
          ...
          for (c = 0; c < t.length; c++)
            if (
              ...
              (u.push({ start: f.start, nativeStart: a, end: f.end, distance: n, trig: f }),
          ...
          b.forEach(function (e) {
            ...
            (e._startClamp && t < 0
              ...
              : (e.ratio < 0 || (e._endClamp && r >= v())) &&
                (n =
                  ((r = v()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) *
                    e.ratio -
                  (e.end - e.start)),
              (e.offset = n || 1e-4),
                ...
                if (e.offset) {
                  if (i) {
                    ...
                    o =
                      d +
                      s +
                      y * ((I.utils.clamp(e.start, e.end, r) - e.start - s) / (n - e.start) - c);
                  }
                  (m.length &&
                    !a &&
                    ...
                    l
                      ? (l.resetTo('y', o, -F, !0), B && l.progress(1))
        ...
        return arguments.length
          ? ((S =
              ...
              (function _wrap(e) {
                ...
                return (
                  t ||
                    ((t = j.createElement('div')).classList.add('ScrollSmoother-wrapper'),
    ...
    (O.forEach(function (e) {
      ...
      (this.smooth = function (e) {
        return (
          arguments.length && ((A = ((H = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
      ...
      t.effects &&
        this.effects(!0 === t.effects ? '[data-' + E + 'speed], [data-' + E + 'lag]' : t.effects, {
      ...
      'overscrollBehavior' in U.getComputedStyle(K) &&
        I.set([K, G], { overscrollBehavior: 'none' }),
